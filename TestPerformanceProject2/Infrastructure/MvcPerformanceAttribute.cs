...
namespace TestPerformanceProject2.Infrastructure
{
    ...
    public class MvcPerformanceAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            // First thing, check if performance tracking has been turned off for this action
        ...
        private ActionInfo CreateActionInfo(ActionExecutingContext actionContext)
        {
            ...
            ActionInfo info = new ActionInfo( ACTION_TYPE,
                controllerName, actionName, httpMethod, parameterString);
